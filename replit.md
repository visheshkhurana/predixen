...
-   **Churn Rate N/A fix**: Health Check (`truth-scan.tsx`) churn display now distinguishes between missing data (shows N/A) and actual 0% churn (shows "0.0%") — was incorrectly showing N/A for 0% churn values.
