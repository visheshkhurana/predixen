...
export function FeedbackWidget() {
  ...
  return (
    <>
      {open && (
        <div className="fixed bottom-16 right-20 z-[1000] w-80 rounded-xl border bg-background shadow-2xl" data-testid="feedback-panel">
      ...
      <Button
        ...
        className="fixed bottom-5 right-20 z-[1000] rounded-full shadow-lg h-10 px-4 gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white"
