...
const scenarioFormSchema = z.object({
  ...
  priceChangePercent: z.coerce.number().min(-100).max(1000).default(0),
  newHires: z.coerce.number().min(-1000).max(1000).default(0),
  costCutPercent: z.coerce.number().min(0).max(100).default(0),
  costCutAmount: z.coerce.number().min(0).default(0),
  newGrowthRate: z.coerce.number().min(-100).max(1000).optional(),
