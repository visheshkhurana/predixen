  ...
  return (
    ...
    >
      ...
      <Switch>
        ...
        <Route path="/security">{() => <Suspense fallback={<div className="flex items-center justify-center min-h-screen"><Loader2 className="h-8 w-8 animate-spin text-muted-foreground" /></div>}><SecurityPage /></Suspense>}</Route>
