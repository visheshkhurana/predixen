...
def extract_with_confidence(raw_metrics: Dict[str, Any], source: str) -> Dict[str, FieldExtraction]:
    ...
    field_mapping = {
        'cashOnHand': ['cash_balance', 'cash_on_hand', 'bank_balance', 'cash', 'cash_and_equivalents', 'total_cash'],
        'monthlyRevenue': ['monthly_revenue', 'revenue', 'mrr', 'net_revenue', 'monthly_recurring_revenue', 'recurring_revenue'],
        'totalMonthlyExpenses': ['total_expenses', 'total_monthly_expenses', 'opex', 'monthly_expenses', 'operating_expenses', 'total_opex'],
        'monthlyGrowthRate': ['mom_growth', 'cmgr_3', 'cmgr_12', 'monthly_growth', 'growth_rate', 'revenue_growth', 'revenue_growth_mom', 'mom_revenue_growth'],
        'payroll': ['payroll', 'salaries', 'employee_costs', 'personnel', 'compensation', 'wages', 'people_costs'],
        'marketing': ['marketing', 'marketing_expenses', 'sales_and_marketing', 'advertising', 'ad_spend', 'paid_acquisition', 'marketing_spend'],
        'operating': ['operating', 'other_opex', 'opex', 'operating_expenses', 'general_admin', 'g_and_a', 'sga'],
        'cogs': ['cogs', 'cost_of_goods_sold', 'direct_costs', 'cost_of_revenue', 'cos'],
        'grossProfit': ['gross_profit', 'gross_income'],
        'grossMargin': ['gross_margin', 'gm'],
        'operatingIncome': ['operating_income', 'ebit', 'ebitda'],
        'operatingMargin': ['operating_margin'],
        'netBurn': ['net_burn', 'burn_rate', 'monthly_burn', 'cash_burn', 'net_cash_burn'],
        'runwayMonths': ['runway_months', 'runway', 'cash_runway', 'months_of_runway'],
        'headcount': ['headcount', 'employees', 'team_size', 'fte', 'full_time_employees', 'staff_count'],
        'customers': ['customers', 'paid_users', 'monthly_active_users', 'mau', 'active_customers', 'paying_customers', 'subscriber_count'],
        'arr': ['arr', 'annual_recurring_revenue', 'annualized_revenue'],
        'ndr': ['ndr', 'net_dollar_retention', 'nrr', 'net_revenue_retention'],
        'grr': ['grr', 'gross_revenue_retention', 'gross_retention'],
        'ltv': ['ltv', 'lifetime_value', 'cltv', 'customer_lifetime_value'],
        'cac': ['cac', 'customer_acquisition_cost', 'acquisition_cost', 'cost_per_acquisition'],
        'ltvCacRatio': ['ltv_cac_ratio', 'ltv_to_cac'],
        'arpu': ['arpu', 'average_revenue_per_user', 'revenue_per_user', 'avg_revenue_per_account'],
        'churnRate': ['churn_rate', 'monthly_churn', 'customer_churn', 'logo_churn', 'churn'],
        'burnMultiple': ['burn_multiple'],
        'quickRatio': ['quick_ratio', 'saas_quick_ratio'],
        'acv': ['acv', 'annual_contract_value', 'avg_contract_value'],
        'dau': ['dau', 'daily_active_users'],
        'gmv': ['gmv', 'gross_merchandise_volume', 'gross_merchandise_value'],
        'aov': ['aov', 'average_order_value', 'avg_order_value'],
        'orderVolume': ['order_volume', 'total_orders', 'orders_per_month', 'monthly_orders'],
        'returnRate': ['return_rate', 'rto_rate', 'rto', 'refund_rate', 'return_percentage'],
        'codPercentage': ['cod_percentage', 'cod_ratio', 'cod_share', 'cash_on_delivery_percentage'],
        'shippingCostPerOrder': ['shipping_cost_per_order', 'shipping_cost', 'delivery_cost', 'logistics_cost'],
        'fulfillmentCost': ['fulfillment_cost', 'warehouse_cost', 'fulfillment_expense'],
        'repeatPurchaseRate': ['repeat_purchase_rate', 'repeat_rate', 'repurchase_rate'],
        'yoyGrowth': ['yoy_growth', 'year_over_year', 'yoy_revenue_growth'],
        'currency': ['currency'],
