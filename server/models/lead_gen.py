"""
Lead-gen tables: campaigns, events, templates, settings.

Paired with server/models/lead.py (which holds the extended Lead model).
Matches the DDL in migrations/0001_lead_gen.sql.
"""
...
class LeadEvent(Base):
    ...
    # simulation_completed | trial_upgraded | unsubscribed | bounced | manual_note | email_queued
