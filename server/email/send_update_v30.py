...
The Flight Simulator now runs a full LLM-powered multi-agent simulation. Seven AI agents — Founder, two Investors, Customer, Team, Market, and Competitor — each with unique LLM-generated personas, make independent decisions every round using OpenAI gpt-5-mini.
...
<p style="font-size:13px;color:#4b5563;margin:0 0 12px;">Seven AI agents &mdash; Founder, two Investors, Customer, Team, Market, and Competitor &mdash; each with unique LLM-generated personas, make independent decisions every round using OpenAI gpt-5-mini.</p>
