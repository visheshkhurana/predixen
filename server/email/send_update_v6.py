...
CAMPAIGN = "predixen_simulation_update_feb2026_v6"
...
<title>Predixen - Simulation Engine Hardened</title>
</head>
...
<p style="margin:0 0 16px;font-size:15px;color:#a7f3d0;">Login with <strong style="color:#ecfdf5;">demo@predixen.ai</strong> / <strong style="color:#ecfdf5;">demo123</strong></p>
    ...
    for sender in SENDERS:
        ...
        for rcpt in RECIPIENTS:
            ...
            result = _send_email_sync(
                to=email,
                subject="Predixen - Simulation Engine Hardened: 16 Critical Fixes Shipped",
                html_content=html,
                from_email=sender,
                recipient_id=rid,
