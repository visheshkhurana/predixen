"""
Send update email v27 - 48-Hour Task Summary: Bug Fixes, Calibration & Stability.
...
CAMPAIGN = "founderconsole_48hr_update_feb2026_v27"
...
def send_all():
    ...
    print(f"Sending 48-hour task update v27 to {len(RECIPIENTS)} recipients...")
