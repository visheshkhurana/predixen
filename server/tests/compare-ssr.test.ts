// /compare was a blank Googlebot shell (ssr_chars=0). Pin a non-empty
// #ssr-content body plus the free-tool / blog / features / auth hrefs.
//
// Run: npx tsx --test server/tests/compare-ssr.test.ts
...
test("/compare SSR body is non-empty and links free tools", () => {
