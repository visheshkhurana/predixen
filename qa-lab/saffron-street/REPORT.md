# Saffron Street Kitchens  FounderConsole UX/QA Report

**Tester Role**: Founder/CEO of an 18-store fast-casual chain (Series A), paying FounderConsole customer
...
| Select Values-In = Millions | PASS | Excellent "Live Preview: You enter 25 -> FounderConsole reads it as 25,000,000" feature |
...
- No glossary mapping restaurant terms to FounderConsole terms (food cost = 1-GM, labor cost = payroll/revenue)  P1
...
### Would I use FounderConsole weekly?

**Today: No.** Here is why:

1. **Trust is broken on page 1.** The baseline simulation tells me my profitable, cash-generating restaurant chain has "13% survival" and rates it "NO-GO." If the first thing FounderConsole tells me is wrong and scary, I close the tab. I would never show this to my board.
...
3. **It does not speak my language.** I think in food cost, labor cost, prime cost, daily sales, and same-store growth. FounderConsole speaks ARR, churn rate, CAC, and NRR. These are SaaS metrics. They mean nothing to me.
...
### What would make me tell other founders about FounderConsole?

If FounderConsole became the "restaurant CFO copilot" that:
...
*Report generated by QA stress test: Saffron Street Kitchens (Synthetic) on FounderConsole v2026-02-14*
