...
def get_or_create_qa_user(db) -> User:
    email = "qa-lab@founderconsole.ai"
...
def generate_report(
    ...
    lines = []
    lines.append("# FounderConsole QA Lab Report")
    lines.append(f"\n**Generated**: {now}")
    ...
    lines.append("---")
    lines.append(f"*Report generated by FounderConsole QA Lab v1.0 on {now}*")
...
def main():
    ...
    print("=" * 60)
    print("  FOUNDERCONSOLE QA LAB RUNNER")
    print("=" * 60)
    print()
