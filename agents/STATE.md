...
| App Engineer (Build pod) | Sample-data first run / signup→first-insight | `server/services/sample_data.py`, onboarding/overview/App sample labels | [#21](https://github.com/visheshkhurana/predixen/pull/21) | claimed 15 Sep 2026 |
